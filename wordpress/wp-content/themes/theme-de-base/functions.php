...
register_nav_menus( 
	array(
		...
		'footer-menu' => __( 'Partenaires', 'Menu principal du site' )
	)
);
...
function add_style_and_js()  { 
	...
	*/
	...
	wp_enqueue_style('default', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css');
	...
	*/
	...
	wp_enqueue_script('gsap-scrollTrigger', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/ScrollTrigger.min.js', array(), false, true);
