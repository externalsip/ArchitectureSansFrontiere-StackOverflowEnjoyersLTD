...
<div itemscope itemtype="https://schema.org/NewsArticle">
      ...
      <section class="nouvelle_hero">
        <div>
          <!-- hero news tag here -->
          <svg class="tag_genre" width="328" height="74" viewBox="0 0 328 74" fill="<?php the_field("tagcolor") ?>" xmlns="http://www.w3.org/2000/svg">
            <path d="M-2 73.9999L260.227 74L328 0.00012207L-2 0V73.9999Z" fill="<?php the_field("tagcolor") ?>"/>
            </svg>
            
          <h1 itemprop="articleSection" class="tag_title"><?php the_field("tagname") ?></h1>
        </div>
        <div class="nouvelle_hero_container container-fluid p-0">
          <!-- hero image here -->
          <div class="row nouvelle_hero_image_row">
            <div class="nouvelle_hero_image col-md-6 col-12" style="background-image: url('<?php the_field("image") ?>') ;">
              <!-- gradient -->
              <div
                class="nouvelle_hero_image_gradient container-fluid p-0"
              ></div>
            </div>
          </div>
          <div class="hero_text">
    ...
    <section class="summary container">
        ...
        <p itemprop="datePublished" class="date"> <?php the_field("date") ?> </p>
    </section>
...
<?php endif; ?>
    ...
    <section class="suggested_article container">
        ...
        <h2 class="nextArticleHeadline">
          PARTICIPEZ : Sondage pour améliorer l’adaptation des bâtiments aux
          inondations
        </h2>
        <p class="nextArticleParagraph">
          Vous êtes concerné.e.s ou préoccupé.e.s par l'adaptation des bâtiments
          aux inondations ? Vous avez un point de vue à [...]
        </p>
      </section>
    </div>
